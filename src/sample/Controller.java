...
public class Controller {
    ...
    public void listAlbumsForArtist() {
        ...
        // We used a hack that exploited the similar naming of the artists and albums classes "name" property
        // in the their tables. We removed the Type parameter from the TableView so that both albums and artists
        // objects can be shown.
        // Ideally Albums and Artists would have their own view ?
        artistTable.itemsProperty().bind(task.valueProperty());
        new Thread(task).start();
    }
