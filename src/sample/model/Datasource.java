...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\Will\\Documents\\Java\\" +
            "Training\\Music\\music\\" + DB_NAME;
    ...
    public static final String QUERY_ARTIST_FOR_SONG_ORDER_BY =
    ...
    private PreparedStatement queryAlbumnsByArtistId;
    ...
    public boolean open() {
        try {
            ...
            queryAlbumnsByArtistId = conn.prepareStatement(QUERY_ALBUMS_BY_ARTIST_ID);
    ...
    public void close() {
        try {
            ...
            if(queryAlbumnsByArtistId != null){
                queryAlbumnsByArtistId.close();
            }
    ...
    public List<Album> queryAlbumsForArtistId(int id) {
        try {
            queryAlbumnsByArtistId.setInt(1, id);
            ResultSet results = queryAlbumnsByArtistId.executeQuery();
    ...
    public int getCount(String table) {
        ...
        try (Statement statement = conn.createStatement();
            ...
            // Best practice is to use the AS keywords to give the desired values a name
            // then and use the names to retrieve the data.
    ...
    // Add code to ensure duplicate songs aren't added.
    public void insertSong(String title, String artist, String album, int track) {
        try {
            ...
            try {
                ...
                System.out.println("Rollback failed....get help!" + e2.getMessage());
            }
        } finally {
            try {
